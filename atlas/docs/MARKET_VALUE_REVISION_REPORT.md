...
7. **Archetype × Industry** — 52개 실제 유형 × 20개 시장을 중앙 서비스에서 계산한다. 13개 시장은 일부 지출 기준을 연결했고 7개는 근거 미확보로 남겼다.
...
11. **Coverage** — 지원 시장 13/20, 직접 지출 0%, 온라인·외식·배달·음악·콘텐츠 유료 이용 전이의 부분 기준, confidence Low를 구분한다. 70%가 전체 소비액 coverage라는 주장은 하지 않는다.
