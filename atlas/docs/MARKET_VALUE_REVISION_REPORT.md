...
7. **Archetype × Industry** — 52개 실제 유형 × 20개 시장을 중앙 서비스에서 계산한다. 12개 시장은 일부 지출 기준을 연결했고 8개는 근거 미확보다.
...
11. **Coverage** — 지원 시장 12/20, 직접 지출 0%, 온라인·외식·배달·음악 결제 전이의 부분 기준, confidence Low를 구분한다. 70%가 전체 소비액 coverage라는 주장은 하지 않는다.
...
22. **Known Limitations** — 합성 프로필, 선별 조사 비율 이식, 조건부 독립·70+ 가정, 온라인 일부 채널, 혼합 기준연도, 8개 시장 미확보, 실제 구매자/가구 식별 미확보. 소득·세그먼트 실측 성장·매출 예측·SOM을 추가하지 않았다.
